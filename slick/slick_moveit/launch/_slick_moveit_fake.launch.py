...
def launch_setup(context, *args, **kwargs):
    ...
    moveit_config_package_name = 'slick_moveit'
    ...
    robot_description_parameters = get_xarm_robot_description_parameters(
        xacro_urdf_file=PathJoinSubstitution([FindPackageShare('slick_description'), 'urdf', 'slick.urdf.xacro']),
        xacro_srdf_file=PathJoinSubstitution([FindPackageShare('slick_moveit'), 'srdf', 'xarm.srdf.xacro']),
        urdf_arguments={
            'prefix': prefix,
